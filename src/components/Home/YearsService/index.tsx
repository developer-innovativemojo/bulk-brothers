...
const YearsService = () => {
  return (
    <>
      <div className="">
        <div
          className="bg-[#191A05] min-h-[200px] flex justify-center items-center pb-[100px] mob:px-5 relative"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-easing="ease-in-out"
        >
          {/* <Image className="absolute  w-full " src={mask} alt="" width={1440} height={520}/> */}

          <div className=" w-full max-w-[1440px] flex justify-end">
            <div className="w-full max-w-[1098px] mt-[-100px] relative">
              <Image src={backimg} alt="" width={1098} height={120} />
              ...
              20 
                ...
                <Text
                  as="h2"
                  className="text-[30px] text-[#E2E1DB] font-bold leading-[38.28px] uppercase mt-[-15px] "
                >
                  Years of Experience
