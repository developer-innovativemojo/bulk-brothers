...
const DeliveryServices: React.FC<WhatWeOfferProps> = ({ id }) => {
  return (
    <>
      <div
        id="delivery-service"
        className={id === "delivery-service" ? "scroll-to-id" : ""}
      >
        <div
          id={id}
          ...
          <div className="w-full max-w-[937px]   flex flex-wrap justify-between items-center py-4">
            ...
            <div className="flex flex-col ">
              <div className="w-full max-w-[561px] mt-7 mob:mt-0">
                ...
                >
                  02 <br className="hidden mob:block" />{" "}
                  <span className="text-[32px]  text-[#FFFFFF] ml-4">
                    Delivery Services
                  </span>
                </Text>
                <Text
                ...
                >
                  Don’t pay high delivery fees or rent a truck to pick up that
                  new item you love. Let Bulk Brothers take care of your
                  delivery needs.
                </Text>
